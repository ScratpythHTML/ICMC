...
public class Quickdraw
{
  ...
  /// <summary>
  /// Gets or sets the expiry date of the quickdraw cited by the manufacturer.
  /// </summary>
  ...
  /// <summary>
  /// Gets of sets the User ID of the committee member who inspected the quickdraw.
  /// </summary>
