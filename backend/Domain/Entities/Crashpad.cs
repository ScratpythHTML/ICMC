...
/// <summary>
/// A crashpad owned by ICMC.
/// </summary>
public class Crashpad
{
  /// <summary>
  ...
  /// <summary>
  /// Gets or sets the expiry date of the crashpad cited by the manufacturer.
  /// </summary>
  ...
  /// <summary>
  /// Gets of sets the User ID of the committee member who inspected the crashpad.
  /// </summary>
